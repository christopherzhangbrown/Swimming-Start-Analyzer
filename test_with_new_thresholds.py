...
# Test the position variance and movement velocity calculations with new thresholds
def test_movement_calculations_new_thresholds():
    print("Testing movement calculations with NEW thresholds...")
    ...
    print(f"NEW threshold (0.002): {'✓ PASS' if position_variance > 0.002 else '✗ FAIL'}")
    print(f"OLD threshold (0.01): {'✓ PASS' if position_variance > 0.01 else '✗ FAIL'}")
    print()
    ...
    print(f"Movement velocity: {avg_movement_velocity:.6f}")
    print(f"NEW threshold (0.008): {'✓ PASS' if avg_movement_velocity > 0.008 else '✗ FAIL'}")
    print(f"OLD threshold (0.02): {'✓ PASS' if avg_movement_velocity > 0.02 else '✗ FAIL'}")

if __name__ == "__main__":
    test_movement_calculations_new_thresholds()
